  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      <Card variant="flat" className="p-6">
        ...
        {error && (
          <div className="mb-6 p-4 rounded-xl border-2 border-red-950 bg-red-50 text-xs text-red-750 flex items-start gap-2.5 shadow-[2px_2px_0px_0px_rgba(9,9,11,1)]">
        ...
        {successMsg && (
          <div className="mb-6 p-4 rounded-xl border-2 border-emerald-950 bg-emerald-50 text-xs text-emerald-750 flex items-start gap-2.5 shadow-[2px_2px_0px_0px_rgba(9,9,11,1)]">
        ...
        <form onSubmit={handleSave} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <select
              ...
              className="w-full px-4 py-3 rounded-xl border-2 border-zinc-950 text-sm focus:outline-none focus:border-violet-500 bg-white font-mono"
            >
              <option value="">Default (Fallback to Env Var: {process.env.AI_PROVIDER || "gemini"})</option>
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              placeholder={`Default (Env default: ${process.env.AUDIT_COOLDOWN_MINUTES || "5"})`}
              className="w-full px-4 py-3 rounded-xl border-2 border-zinc-950 text-sm focus:outline-none focus:border-violet-500 bg-white font-mono"
              min={0}
            />
            <div className="flex items-center gap-2 mt-1">
          ...
          <div className="pt-4 border-t border-zinc-150 flex justify-end">
            <button
              type="submit"
              disabled={saving}
              className="px-5 py-2.5 border-2 border-zinc-950 bg-violet-600 text-white font-bold text-xs uppercase tracking-wider rounded-xl transition-all shadow-[2px_2px_0px_0px_rgba(9,9,11,1)] hover:bg-violet-750 flex items-center gap-2 disabled:opacity-50"
            >
